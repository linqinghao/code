...
let singyLinkList = new SingyLinkList()

console.log(singyLinkList.removeAt(0))
console.log(singyLinkList.isEmpty())

singyLinkList.append('Alin')

singyLinkList.append('Banana')

singyLinkList.append('Coral')

singyLinkList.print()

singyLinkList.insert(1, 'Zoz')
